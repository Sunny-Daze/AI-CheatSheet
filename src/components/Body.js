  ...
  return (
    <StyleRoot>
      <div className="container-fluid parent-container">
        <div className="row">
          <div className="col my-4 mx-4" style={styles.fadeInLeft}>
            <Panel1 mode={props.mode} />
          </div>
          <div className="col my-4 mx-4" style={styles.fadeInDown}>
            <Panel2 mode={props.mode} />
          </div>
          <div className="col my-4 mx-4" style={styles.fadeInRight}>
        ...
        <div className="row">
          ...
          <div className="col my-4 mx-4" style={styles.fadeInUp}>
